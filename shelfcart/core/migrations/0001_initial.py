    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='books', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999999999)),
                ('specifications', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True)),
                ('type', models.CharField(blank=True, default='Fiction', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='Iam an Amazing Vendor', null=True)),
